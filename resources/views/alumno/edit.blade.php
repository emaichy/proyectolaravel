            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="email" class="form-control" id="Correo" name="Correo"
                        value="{{ old('Correo', $alumno->usuario->Correo) }}" required>
                </div>
                <div class="col-md-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="ApePaterno" name="ApePaterno"
                        value="{{ old('ApePaterno', $alumno->ApePaterno) }}" required>
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="ApeMaterno" name="ApeMaterno"
                        value="{{ old('ApeMaterno', $alumno->ApeMaterno) }}" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-5">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control" id="NumeroExterior" name="NumeroExterior"
                        value="{{ old('NumeroExterior', $alumno->NumeroExterior) }}" required>
                </div>
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control" id="NumeroInterior" name="NumeroInterior"
                        value="{{ old('NumeroInterior', $alumno->NumeroInterior) }}">
                </div>
                <div class="col-md-3">
                    <label for="CodigoPostal" class="form-label">Código Postal</label>
                    <input type="text" class="form-control" id="CodigoPostal" name="CodigoPostal"
                        value="{{ old('CodigoPostal', $alumno->CodigoPostal) }}" required>
                </div>
            </div>
            <div class="mb-4">
                <label for="FechaNac" class="form-label">Fecha de Nacimiento</label>
                <input type="date" class="form-control" id="FechaNac" name="FechaNac"
                    value="{{ old('FechaNac', $alumno->FechaNac) }}" required>
            </div>
            <div class="row mb-4">
                <div class="col-md-4">
                    <label for="Curp" class="form-label">CURP</label>
                    <input type="text" class="form-control" id="Curp" name="Curp"
                        value="{{ old('Curp', $alumno->Curp) }}" required>
                </div>
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="Sexo" name="Sexo" required>
                        ...
                        <option value="Masculino" {{ old('Sexo', $alumno->Sexo) == 'Masculino' ? 'selected' : '' }}>
                            Masculino</option>
                        <option value="Femenino" {{ old('Sexo', $alumno->Sexo) == 'Femenino' ? 'selected' : '' }}>Femenino
                        </option>
                    </select>
                </div>
                <div class="col-md-4">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Pais" name="Pais"
                        value="{{ old('Pais', $alumno->Pais) }}" required>
                </div>
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="ID_Estado" name="ID_Estado" required>
                        ...
                        @foreach ($estados as $estado)
                            <option value="{{ $estado->ID_Estado }}"
                                {{ old('ID_Estado', $alumno->ID_Estado) == $estado->ID_Estado ? 'selected' : '' }}>
                                {{ $estado->NombreEstado }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="ID_Municipio" name="ID_Municipio" required
                        {{ old('ID_Estado', $alumno->ID_Estado) ? '' : 'disabled' }}>
                        @if (old('ID_Estado', $alumno->ID_Estado) && isset($municipios))
                            <option value="">Seleccione un municipio...</option>
                            @foreach ($municipios as $municipio)
                                <option value="{{ $municipio->ID_Municipio }}"
                                    {{ old('ID_Municipio', $alumno->ID_Municipio) == $municipio->ID_Municipio ? 'selected' : '' }}>
                    ...
                    fetch(`/municipiosEstado/${estadoId}`)
                        ...
                        .then(data => {
                            if (data.length > 0) {
                                ...
                                const oldMunicipio =
                                    "{{ old('ID_Municipio', $alumno->ID_Municipio) }}";
                                if (oldMunicipio) {
