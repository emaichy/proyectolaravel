...
@section('title', 'Gestionar Grupos del Alumno')
...
<div class="container py-5">
    <div class="card shadow-lg">
        <div class="card-header bg-success text-white">
            <h2 class="mb-0">
                <i class="bi bi-person-lines-fill"></i> Gestionar Grupos: {{ $alumno->Nombre }} {{ $alumno->ApePaterno }}
            </h2>
        </div>
        <div class="card-body">
            <div class="row">
                                ...
                                <tbody>
                                    @foreach($gruposAsignados as $grupo)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('alumnos.desasignar-grupo', ['alumno' => $alumno->ID_Alumno, 'grupo' => $grupo->ID_Grupo]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                ...
                <div class="col-md-6">
                    ...
                    <form action="{{ route('alumnos.asignar-grupo', $alumno->ID_Alumno) }}" method="POST">
                        @csrf
                        <div class="mb-3">
            ...
            <div class="mt-4">
                <a href="{{ route('alumnos.show', $alumno->ID_Alumno) }}" class="btn btn-secondary">
