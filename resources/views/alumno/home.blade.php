            ...
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4 mb-3">
                            <a href="{{ route('alumno.mis_pacientes.index') }}" class="text-decoration-none text-dark">
                                <div class="card h-100 shadow-sm">
                                    <div class="card-body">
                                        <i class="fas fa-users fa-2x mb-2 text-danger"></i>
                                        <h5 class="card-title">Mis Pacientes</h5>
                                        <p class="card-text">Consulta los pacientes que tienes asignados y accede a sus documentos.</p>
                                    </div>
                                </div>
                            </a>
                    </div>
