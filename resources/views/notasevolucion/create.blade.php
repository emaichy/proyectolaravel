            ...
            <div class="col-md-6">
                ...
                <select name="ID_Expediente" class="form-control">
                    ...
                    @foreach($expedientes as $expediente)
                        <option value="{{ $expediente->ID_Expediente }}" {{ old('ID_Expediente') == $expediente->ID_Expediente ? 'selected' : '' }}>
        ...
        <div class="row mb-4">
            ...
            @if(auth()->check() && auth()->user()->Rol === 'Alumno')
                <div class="col-md-4 text-center">
                    ...
                    <input type="hidden" name="firma_alumno" id="firma_alumno_input">
                    <button type="button" onclick="limpiarCanvas('firma_alumno')" class="btn btn-sm btn-secondary mt-1">Limpiar</button>
                </div>
            @endif

            {{-- Firma del paciente (puede estar presente para ambos roles) --}}
            <div class="col-md-4 text-center">
