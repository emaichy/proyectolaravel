...
<div class="container">
    ...
    <form action="{{ route('pacientes.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="TipoPaciente" name="TipoPaciente" required>
        </div>

        <div class="mb-3">
            <label for="Foto_Paciente" class="form-label">Foto del Paciente</label>
            <input type="file" class="form-control" id="Foto_Paciente" name="Foto_Paciente" accept="image/*">
        </div>
