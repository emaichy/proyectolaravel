...
@section('content')
    ...
    <div class="container py-4">
        ...
        @if (isset($todosLosGrupos) && count($todosLosGrupos) > 1)
                ...
                <div class="modal-content">
                    <form id="form-agregar-alumnos" method="POST"
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" id="btn-submit-alumnos"
                ...
                function cargarGrupo(id) {
                    fetch(`/grupos_maestros/ajax/${id}`)
                        ...
                        .then(data => {
                            ...
                            history.pushState(null, '', `/grupos_maestros/${id}`);
                            @if ($rol === 'Administrativo')
