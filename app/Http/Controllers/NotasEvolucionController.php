   ...
   public function create(Request $request)
{
    ...
    // 🆕 Obtener el paciente_id de la URL
    $pacienteId = $request->query('paciente_id');
    $pacienteSeleccionado = null;

    if ($pacienteId) {
        // Verifica que el paciente pertenezca a los asignados
        $pacienteSeleccionado = $pacientesAsignados->firstWhere('ID_Paciente', $pacienteId);
    }
